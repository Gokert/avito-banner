...
func GetBannerPsxConfig() (*DbPsxConfig, error) {
	...
	cfg := &DbPsxConfig{
		User:         v.GetString("BANNER_PSX_USER"),
		Password:     v.GetString("BANNER_PSX_PASSWORD"),
		Dbname:       v.GetString("BANNER_PSX_DBNAME"),
		Host:         v.GetString("BANNER_PSX_HOST"),
		Port:         v.GetInt("BANNER_PSX_PORT"),
		Sslmode:      v.GetString("BANNER_PSX_SSLMODE"),
		MaxOpenConns: v.GetInt("BANNER_PSX_MAXCONNS"),
		Timer:        v.GetInt("BANNER_PSX_TIMER"),
	}
